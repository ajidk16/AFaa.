...
import RatingRadioGroup from "./rating-tadio-group";

import { IcLazada, IcTokopedia } from "@/assets/png";
          ...
          <Dropdown>
            ...
            <DropdownMenu aria-label="Dropdown menu with icons" variant="faded">
              <DropdownItem
                key="shopee"
                // shortcut="⌘N"
                startContent={<SiShopee color="#EE4D2D" size={20} />}
              >
                Shopee
              </DropdownItem>
              <DropdownItem
                key="tiktok"
                // shortcut="⌘N"
                startContent={<FaTiktok color="#000" size={20} />}
              >
                Tiktok
              </DropdownItem>
              <DropdownItem
                key="Tokopedia"
                // shortcut="⌘N"
                startContent={<Image src={IcTokopedia.src} width={20} />}
              >
                Tokopedia
              </DropdownItem>
              <DropdownItem
                key="Lazada"
                // shortcut="⌘N"
                startContent={<Image src={IcLazada.src} width={20} />}
              >
                Lazada
              </DropdownItem>
            </DropdownMenu>
